...
const styles = StyleSheet.create({
  ...
  messageLabel: { color: colors.onSurfaceSecondary, fontFamily: fonts.text, fontSize: fontSize.sm, marginBottom: spacing.sm },
});
