...
export default function AdminBookingDetail() {
  ...
  const schedule = async () => {
    if (!scheduledDate || !startTime || !endTime || !venue) { toast.show("Add date, time, and venue before scheduling", "error"); return; }
    try {
